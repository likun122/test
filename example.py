...
if __name__ == '__main__':
    #实盘主账户 读取 提现
    # api_key = "7aa18e84-2177-4932-9f7e-8d237f9c2ed8"
    # secret_key = "4496799C6844BDE204058CC5EBB5E047"
    # passphrase = "122656Li."
    # 实盘主账户 只读
    api_key = "7a775c28-4a0f-4a99-a611-b1554371c1bb"
    secret_key = "A898EF3085182E953AEB7A20188B0A5A"
    passphrase = "1226565550@Lk"
    #模拟盘账户
    # api_key = "4c13b52e-7b35-4148-a1a0-1a2a64fd5a19"
    # secret_key = "64B51D9861440F59194EAECBDCD22A3A"
    # passphrase = "122656Li."
    ...
    # 查看历史持仓信息
    # result = accountAPI.get_positions_history(instType = 'SWAP', instId = 'BTC-USDT-SWAP', mgnMode = '', type = '', after = '', before = '', limit = '', posId = '')
    ...
    # 设置杠杆倍数  Set Leverage
    # result = accountAPI.set_leverage(instId='BTC-USDT', lever='3',ccy='BTC', mgnMode='cross')
    # 获取最大可交易数量  Get Maximum Tradable Size For Instrument
    # result = accountAPI.get_maximum_trade_size(instId='DOT-USDT', tdMode='cash',ccy='',px='6.08',leverage='5',unSpotOffset='false')
    # 获取最大可用数量  Get Maximum Available Tradable Amount
    # result = accountAPI.get_max_avail_size(instId='DOT-USDT', tdMode='cross', ccy='DOT', reduceOnly='', unSpotOffset='',quickMgnType='auto_borrow')
    # 调整保证金  Increase/Decrease margint
    # result = accountAPI.Adjustment_margin('BTC-USDT-210409', 'long', 'add', '100')
    # 获取杠杆倍数 Get Leverage
    # result = accountAPI.get_leverage(instId='BTC-USDT', mgnMode='cross')
    ...
    # 资金划转  Funds Transfer
    # result = fundingAPI.funds_transfer(ccy='USDT', amt='1', type='0', froms="18", to="6",subAcct='',loanTrans='',clientId='',omitPosRisk='')
    # 获取资金划转状态 Transfer State
    # result = fundingAPI.transfer_state(transId='', type='')
    # 提币  Withdrawal
    # result = fundingAPI.coin_withdraw(ccy='ETH', amt='0.001', dest='4', toAddr='0xd73157c5b8dbf584bc3d5540ce702ebe9300a1f0', fee='0.0001', chain='ETH-ZKSYNC', areaCode='', clientId='')
    # 获取充值记录  Get Deposit History
    # result = fundingAPI.get_deposit_history()
    # 获取币种列表  Get Currencies
    result = fundingAPI.get_currency('ETH')
    ...
    #                                   sidee='sell', sz='1', szCcy='USDT', clTReqId='',tag='')
    ...
    # result = marketAPI.get_index_ticker(quoteCcy='USD')
    # 获取产品深度  Get Order Book
    # result = marketAPI.get_orderbook('BTC-USDT', '')
    # 获取产品轻量深度
    # result = marketAPI.get_books_lite(instId = 'BTC-USDT')
    # 获取所有交易产品K线数据  Get Candlesticks
    # result = marketAPI.get_candlesticks('ETH-USDT-SWAP', bar='30m',after='')
    # 获取交易产品历史K线数据（仅主流币实盘数据）  Get Candlesticks History（top currencies in real-trading only）
    # result = marketAPI.get_history_candlesticks(instId='BTC-USD-SWAP',bar = '1m',before = '1668683160000',after = '1668683340000')
    ...
    # result = marketAPI.get_history_markprice_candlesticks(instId='ETH-USDT-SWAP', after='1680537600',before='1640966400', bar='1m', limit='100')
    ...
    # 获取交易产品公共历史成交数据
    # result = marketAPI.get_history_trades(instId = 'VELODROME-USDT', type = '2',after = '1679039971236', before = '', limit = '')
    # 获取大宗交易所有产品行情信息
    ...
    # result = publicAPI.get_liquidation_orders(instType='SWAP', uly='BTC-USDT',state='filled')
    ...
    # 张币转换
    # result = publicAPI.convert_contract_coin(type = '1', instId = 'ETH-USDT-SWAP', sz = '1', px = '1602.72', unit = 'usdt')
    ...
    # 下单  Place Order
    # result = tradeAPI.place_order(instId='ETH-USDT-231010',tdMode='cash',side='sell',ordType='market',sz='0.01',tgtCcy='base_ccy')
    # 批量下单  Place Multiple Orders
    # result = tradeAPI.place_multiple_orders([
    #     {'instId': 'BTC-USDT', 'tdMode': 'cash', 'side': 'buy', 'ordType': 'limit', 'sz': '0.00001', 'px': '17400',
    #      'posSide': 'net',
    #      'clOrdId': '1', 'tag': 'test1210','tgtCcy':''}]
    ...
    # result = tradeAPI.close_positions(instId='BTC-USDT-SWAP', posSide='', mgnMode='isolated',ccy='', autoCxl='false',clOrdId='',tag='')
    # 获取订单信息  Get Order Details
    # result = tradeAPI.get_orders('BTC-USDT-SWAP', '563753417437433856')
    ...
    # result = tradeAPI.get_orders_history(instType = 'SWAP', uly = '', instFamily = '', instId = '', ordType = '', state = '', category = '', after = '', before = '570640451707953152', begin = '', end = '1681639835216', limit = '')
    # 获取历史订单记录（近三个月） Get Order History (last 3 months)
    # result = tradeAPI.orders_history_archive(instType = 'SWAP', uly = '', instFamily = '', instId = '', ordType = '', state = '', category = '', after = '', before = '570640451707953152', begin = '', end = '', limit = '')
    ...
    # result = tradeAPI.place_algo_order(instId = 'ETH-USDT-SWAP', tdMode='cross', side = 'sell', ordType='oco',
    #                                    sz='1',posSide='long', tpTriggerPx='1500.15', tpOrdPx='1500.15',
    #                                   tpTriggerPxType = 'mark', slTriggerPxType = 'mark', clOrdId ='',
    #                                    slTriggerPx = '1100.15',quickMgnType='', closeFraction = '',slOrdPx = '-1')
    ...
    # result = tradeAPI.order_algos_list('trigger')
    ...
    # 网格策略停止
    # result = TradingBot.grid_stop_order_algo(algoId = '570333049658015744', instId = 'BTC-USDT', algoOrdType = 'grid', stopType = '1')
    # 获取未完成网格策略委托单列表
    # result = TradingBot.grid_orders_algo_pending(algoOrdType = 'contract_grid', algoId = '', instId = '', instType = '', after = '', before = '', limit = '')
    # 获取历史网格策略委托单列表
