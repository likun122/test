...
# channels = [{'channel': 'candle1m', 'instId': 'BCH-USDT-SWAP'},]
# 交易频道 Trades Channel
# channels = [{"channel": "trades", "instId": "BTC-USD-SWAP"}]
...
# channels = [{'channel': 'mark-price-candle1m', 'instId': 'ETH-USDT-SWAP'}]
# 限价频道 Price Limit Channel
# channels = [{"channel": "price-limit", "instId": "BTC-USDT-SWAP"}]
# 深度频道 Order Book Channel
channels = [{"channel": "books5", "instId": "BTC-USDT"}]
# 期权定价频道 OPTION Summary Channel
# channels = [{"channel": "opt-summary", "instFamily": "BTC-USDT"}]
...
# channels = [{"channel": "orders-algo", "instType": "SWAP", "uly": "BTC-USD", "instId": "BTC-USD-SWAP"}]
